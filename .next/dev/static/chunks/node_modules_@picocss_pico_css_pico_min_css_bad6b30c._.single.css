/* [project]/node_modules/@picocss/pico/css/pico.min.css [app-client] (css) */
:host, :root {
...
:is([role="group"]:has(button.secondary:focus, [type="submit"].secondary:focus, [type="button"].secondary:focus, [role="button"].secondary:focus), [role="search"]:has(button.secondary:focus, [type="submit"].secondary:focus, [type="button"].secondary:focus, [role="button"].secondary:focus)) {
  --pico-group-box-shadow-focus-with-button: 0 0 0 var(--pico-outline-width) var(--pico-secondary-focus);
}

:is([role="group"]:has(button.contrast:focus, [type="submit"].contrast:focus, [type="button"].contrast:focus, [role="button"].contrast:focus), [role="search"]:has(button.contrast:focus, [type="submit"].contrast:focus, [type="button"].contrast:focus, [role="button"].contrast:focus)) {
...
:host(:not([data-theme="dark"])) input:is([type="submit"], [type="button"], [type="reset"], [type="checkbox"], [type="radio"], [type="file"]), :root:not([data-theme="dark"]) input:is([type="submit"], [type="button"], [type="reset"], [type="checkbox"], [type="radio"], [type="file"]), [data-theme="light"] input:is([type="submit"], [type="button"], [type="reset"], [type="checkbox"], [type="radio"], [type="file"]) {
...
@media only screen and (prefers-color-scheme: dark) {
  ...
  :host(:not([data-theme])) input:is([type="submit"], [type="button"], [type="reset"], [type="checkbox"], [type="radio"], [type="file"]), :root:not([data-theme]) input:is([type="submit"], [type="button"], [type="reset"], [type="checkbox"], [type="radio"], [type="file"]) {
    --pico-form-element-focus-color: var(--pico-primary-focus);
  }

  :host(:not([data-theme])) details summary[role="button"].contrast:not(.outline):after, :root:not([data-theme]) details summary[role="button"].contrast:not(.outline):after, :host(:not([data-theme])) [aria-busy="true"]:not(input, select, textarea).contrast:is(button, [type="submit"], [type="button"], [type="reset"], [role="button"]):not(.outline):before, :root:not([data-theme]) [aria-busy="true"]:not(input, select, textarea).contrast:is(button, [type="submit"], [type="button"], [type="reset"], [role="button"]):not(.outline):before {
    filter: brightness(0);
  }
}
...
[role="button"]:is(:hover, :active, :focus), [role="button"][aria-current]:not([aria-current="false"]), [type="button"]:is(:hover, :active, :focus), [type="button"][aria-current]:not([aria-current="false"]), [type="reset"]:is(:hover, :active, :focus), [type="reset"][aria-current]:not([aria-current="false"]), [type="submit"]:is(:hover, :active, :focus), [type="submit"][aria-current]:not([aria-current="false"]), button:is(:hover, :active, :focus), button[aria-current]:not([aria-current="false"]) {
...
[role="button"]:focus, [role="button"][aria-current]:not([aria-current="false"]):focus, [type="button"]:focus, [type="button"][aria-current]:not([aria-current="false"]):focus, [type="reset"]:focus, [type="reset"][aria-current]:not([aria-current="false"]):focus, [type="submit"]:focus, [type="submit"][aria-current]:not([aria-current="false"]):focus, button:focus, button[aria-current]:not([aria-current="false"]):focus {
...
@supports selector(:has(*)) {
  :is([role="group"]:has(button:focus, [type="submit"]:focus, [type="button"]:focus, [role="button"]:focus), [role="search"]:has(button:focus, [type="submit"]:focus, [type="button"]:focus, [role="button"]:focus)) {
  ...
  :is([role="group"]:has(input:not([type="submit"], [type="button"]):focus, select:focus), [role="search"]:has(input:not([type="submit"], [type="button"]):focus, select:focus)) {
...
/*# sourceMappingURL=node_modules_%40picocss_pico_css_pico_min_css_bad6b30c._.single.css.map*/