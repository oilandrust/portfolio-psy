...
Qui plus est l'apport de la présence du thérapeute permet de donner plus de capacité au patient d'être en contact avec son expérience. Le thérapeute opérant comme le caregiver qui aide l'enfant à réguler ses émotions. Autrement dit, le thérapeute en pleine conscience remplit une fonction de contenance qui aide le patient à développer sa propre capacité à contenir son expérience (Bion 1991).

Cette approche de la thérapie, notamment proposée par Hakomi (Kurtz 2015), Daniel Siegel (Siegel 2007), permet l'étude de l'appareil psycho-corporel comme Freud en aurait peut être rêvé, non dans l'analyse après coup mais dans l'instant présent incarné. Cela donne aussi accès à des états modifiés de conscience et une neuroplasticité qui permet une transformation rapide du matériel inconscient, des schémas limitants et des *working models* d'attachement (Rhonda 2020). J'ai pu dans ma pratique de la thérapie Hakomi observer la résolution de tendances relationnelles en une session chez un client qui avait de très bonnes bases et il y a des rapports de transformations similaires dans Hakomi. Je reste convaincu cependant que de nombreux problèmes nécessitent une prise en charge longue dans ces thérapies, aussi efficaces peuvent-elles paraître.

**Bibliographie**

Bion, W. R. (1991). _Learning from experience_ (Eighth printing). Karnac.
